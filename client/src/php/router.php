...
{
    if (($_SERVER["REQUEST_METHOD"] ?? "") === "POST" && isset($_POST["ts_form"]) && $_POST["ts_form"] === "contact") {
        try {
            ...
            $GLOBALS["TS_CONTACT_MSG"] = "Thank you. Your inquiry has been received.";
    ...
    $appRoot = dirname(__DIR__) . DIRECTORY_SEPARATOR . "app";
